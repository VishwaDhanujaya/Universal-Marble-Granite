        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div class="lg:col-span-7 space-y-8">
                ...
                <div class="space-y-6 text-brand-gray font-sans text-sm sm:text-base leading-relaxed">
                    ...
                    <p>
                        Our commitment to quality, luxury, and unmatched reliability has made us the preferred choice for top architects, developers, and interior designers looking to add timeless elegance to their landmark projects.
                    </p>
                </div>
                <div class="pt-4">
