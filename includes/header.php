...
<head>
    ...
    <!-- Favicon / Title Image -->
    <link rel="icon" type="image/png" href="/universalgranite/assets/images/logo.png?v=1.0">
    <link rel="shortcut icon" type="image/png" href="/universalgranite/assets/images/logo.png?v=1.0">
    <link rel="apple-touch-icon" href="/universalgranite/assets/images/logo.png?v=1.0">
    ...
    <meta property="og:image" content="/universalgranite/assets/images/logo.png">
    <meta property="og:url" content="http://localhost/universalgranite/<?= basename($_SERVER['PHP_SELF']) ?>">
    ...
    <meta name="twitter:image" content="/universalgranite/assets/images/logo.png">
    ...
    <?php else: ?>
        ...
        <link rel="stylesheet" href="/universalgranite/dist/assets/index.css">
        <script type="module" src="/universalgranite/dist/assets/index.js"></script>
    <?php endif; ?>
</head>
