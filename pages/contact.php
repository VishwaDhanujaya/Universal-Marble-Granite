                ...
                <form action="#" method="POST" class="space-y-6" x-data="{ 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="name" required class="w-full px-4 py-3 bg-neutral-50/50 border border-neutral-200 focus:outline-none focus:border-brand-accent focus:ring-2 focus:ring-brand-accent-light/35 rounded-sm transition-all duration-300 text-sm text-brand-dark">
                        </div>
                        <div>
                            <label for="email" class="block text-xs font-semibold uppercase tracking-wider text-brand-gray mb-2">Your Email *</label>
                            <input type="email" id="email" required class="w-full px-4 py-3 bg-neutral-50/50 border border-neutral-200 focus:outline-none focus:border-brand-accent focus:ring-2 focus:ring-brand-accent-light/35 rounded-sm transition-all duration-300 text-sm text-brand-dark">
                        </div>
                    </div>
                    
                    <div>
                        <label for="subject" class="block text-xs font-semibold uppercase tracking-wider text-brand-gray mb-2">Subject</label>
                        <input type="text" id="subject" class="w-full px-4 py-3 bg-neutral-50/50 border border-neutral-200 focus:outline-none focus:border-brand-accent focus:ring-2 focus:ring-brand-accent-light/35 rounded-sm transition-all duration-300 text-sm text-brand-dark">
                    </div>
                    
                    <div>
                        <label for="message" class="block text-xs font-semibold uppercase tracking-wider text-brand-gray mb-2">Your Message *</label>
                        <textarea id="message" rows="5" required class="w-full px-4 py-3 bg-neutral-50/50 border border-neutral-200 focus:outline-none focus:border-brand-accent focus:ring-2 focus:ring-brand-accent-light/35 rounded-sm transition-all duration-300 text-sm text-brand-dark resize-none"></textarea>
                    </div>
                    
                    <button type="submit" class="w-full btn-primary py-3.5 focus:outline-none focus:ring-2 focus:ring-brand-accent-light/40" :class="{'opacity-75 cursor-wait': submitted}">
                        <span x-show="!submitted">Send Message</span>
                        <span x-show="submitted" style="display:none;">Sending...</span>
                    </button>
                    
                    <div x-show="submitted" style="display:none;" class="p-4 mt-4 bg-green-50 border border-green-200 text-green-700 text-sm rounded">
